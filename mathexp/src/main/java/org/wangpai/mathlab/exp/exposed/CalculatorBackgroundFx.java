...
import org.wangpai.mathlab.symbol.operator.Operator;
...
import static org.wangpai.mathlab.symbol.enumeration.Symbol.ADD;
import static org.wangpai.mathlab.symbol.enumeration.Symbol.DIVIDE;
import static org.wangpai.mathlab.symbol.enumeration.Symbol.DOT;
import static org.wangpai.mathlab.symbol.enumeration.Symbol.EQUAL;
import static org.wangpai.mathlab.symbol.enumeration.Symbol.LEFT_BRACKET;
import static org.wangpai.mathlab.symbol.enumeration.Symbol.RIGHT_BRACKET;
import static org.wangpai.mathlab.symbol.enumeration.Symbol.ZERO;
...
public class CalculatorBackgroundFx {
     ...
     * @lastModified 2022-8-24
     */
    private void notifyExceptionPromptMsg(MathlabException exception) {
        this.setState(ERROR);
    ...
    public void readExpression(final String expression) {
        ...
        if (needCompletion) {
            ...
            try {
                this.expressionCheck(calData.clearAllCalData(), expression + "=");
            } catch (MathlabException exception) { // 如果发生了异常，说明本次的等号补充是不合理的
    ...
    private void judgeZeroDivisor(CalculatorData calData, OutputStream outputStream) throws MathlabException {
        /**
