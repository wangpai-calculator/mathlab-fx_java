...
import org.wangpai.calculator.model.data.Action;
import org.wangpai.calculator.model.data.CalculatorData;
import org.wangpai.calculator.model.data.CalculatorState;
...
import static org.wangpai.calculator.model.data.CalculatorState.END;
import static org.wangpai.calculator.model.data.CalculatorState.ERROR;
import static org.wangpai.calculator.model.data.CalculatorState.INIT;
import static org.wangpai.calculator.model.data.CalculatorState.NORMAL;
...
public class CalculatorBackgroundFx {
     ...
     * @lastModified 2022-8-24
     */
    private void notifyExceptionPromptMsg(CalculatorException exception) {
        this.setState(ERROR);
    ...
    private void judgeZeroDivisor(CalculatorData calData, OutputStream outputStream) throws CalculatorException {
        /**
