...
//        }
    ...
    /**
     * 向上取整。得到一个不小于 rationalNumber 的最小整数。如 对 1.5 的向上取整结果为 2
     *
     * @since 2022-8-24
     */
    public static Figure roundUp(RationalNumber rationalNumber) {
        if (rationalNumber.getDenominator().equals(Figure.ONE)) {
            return rationalNumber.getNumerator().clone();
        } else {
            var quotient = FigureOperation.modsQuotient(rationalNumber.getNumerator(),
    ...
    /**
     * 向下取整。得到一个不大于 rationalNumber 的最大整数。如 对 1.5 的向上取整结果为 1
     *
     * @since 2022-8-24
     */
    public static Figure roundDown(RationalNumber rationalNumber) {
        return FigureOperation.modsQuotient(rationalNumber.getNumerator(), rationalNumber.getDenominator());
    }
}
