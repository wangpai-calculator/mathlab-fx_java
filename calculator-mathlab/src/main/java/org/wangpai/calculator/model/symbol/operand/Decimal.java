...
public final class Decimal implements Operand {
    ...
    @Override
    public boolean isZero() throws CalculatorException {
        throw new UndefinedException("异常：不支持此运算"); // 暂时不想实现
    }

    @Override
    public boolean isPositive() throws CalculatorException {
        throw new UndefinedException("异常：不支持此运算"); // 暂时不想实现
    }

    @Override
    public boolean isNegative() throws CalculatorException {
        throw new UndefinedException("异常：不支持此运算"); // 暂时不想实现
    }
}
