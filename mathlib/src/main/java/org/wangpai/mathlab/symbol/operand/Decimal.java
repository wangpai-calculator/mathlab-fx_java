...
public final class Decimal implements Operand {
    ...
    @Override
    @Deprecated
    public boolean isZero() throws MathlabException {
        throw new UndefinedException("异常：不支持此运算"); // 暂时不想实现
    }

    @Override
    @Deprecated
    public boolean isPositive() throws MathlabException {
        throw new UndefinedException("异常：不支持此运算"); // 暂时不想实现
    }

    @Override
    @Deprecated
    public boolean isNegative() throws MathlabException {
        throw new UndefinedException("异常：不支持此运算"); // 暂时不想实现
    }
}
